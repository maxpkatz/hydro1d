...
module probparams_module
  ...
  real (kind=dp_t), save :: rho_l = 2.0_dp_t
  real (kind=dp_t), save :: p_l   = 1.0_dp_t

  real (kind=dp_t), save :: rho_t = 1.0_dp_t
  real (kind=dp_t), save :: p_t   = 1.0_dp_t

  real (kind=dp_t), save :: width = 0.125_dp_t
  
  real (kind=dp_t), save :: v_adv = 0.0_dp_t

  ! namelist
  namelist /problem/ rho_l, p_l, rho_t, p_t, width, v_adv
